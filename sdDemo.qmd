...
# Or, run this to install t he Quarto extension:
# surveydown::sd_update_extension()

# Load the package from library:
library(surveydown)

# Or, load the package locally:
...
# No quotation needed
# Finally, restart R session by Session -> Restart R
# Shortcut for restarting R: cmd+shift+0 (Mac), ctrl+shift+F10 (Win)
