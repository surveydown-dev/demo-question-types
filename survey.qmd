...
# To set your supabase password in this project,
# run sd_set_password("your_password") in the R Console.
...
db <- sd_database(
  ...
  table_name = "demo",
  gssencmode = "disable" # Use this if supabase connection fails
  # pause      = TRUE # Pauses the database connection
)
...
config <- sd_config(
  ...
  all_questions_required = TRUE # Turn on to make all questions required
